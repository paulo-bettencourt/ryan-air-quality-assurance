...
public class steps_acc_selector {
    ...
    public void clickAccountDetailsTab() {
        ...
        WebElement text =driver.findElement(By.xpath("//a[contains(text(), ' Account Info' ) ]"));
        text.click();
    }
